...
export default function AnimatedOrb({ size, level, isTransitioning, monochrome, isDark = false }: AnimatedOrbProps) {
    ...
    >
      ...
      >
        <BlurView
          ...
          style={[StyleSheet.absoluteFill, { borderRadius: size * 0.4 }]}
        />
        <LinearGradient
          colors={theme.mid}
          start={{ x: 0.2, y: 0 }}
      ...
      {/* Inner layer - fastest rotation with glass */}
      <Animated.View
        style={[
          styles.layer,
          {
      ...
      {/* Core - bright center with rotation and glass effect */}
      <Animated.View
        style={[
          styles.core,
          {
      ...
      >
        ...
        <BlurView
          ...
          tint={isDark ? "dark" : "light"}
          style={[StyleSheet.absoluteFill, { borderRadius: size * 0.175 }]}
        />
        <LinearGradient

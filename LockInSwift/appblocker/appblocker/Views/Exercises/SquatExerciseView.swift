...
/// Squat exercise view - counts per rep and gives rewards progressively
struct SquatExerciseView: View {
    ...
    // Reward rate: 0.3 min per rep
    private let rewardPerRep: Double = 0.3
    ...
    var body: some View {
                        ...
                        HStack {
                            ...
                            HStack(spacing: 12) {
                                ...
                                VStack(alignment: .leading, spacing: 2) {
                                    Text(L10n.Exercise.squats)
                                        .font(.system(size: 17, weight: .bold))
                                        .foregroundStyle(.white)

                                    Text(ExerciseType.squats.localizedDescription)
                                        .font(.system(size: 12))
        ...
        .onAppear {
            let handler = ExerciseFrameHandler(detection: exerciseDetection, type: .squats)
        ...
        .sheet(isPresented: $showInfoSheet) {
            ExerciseInfoSheet(exerciseType: .squats) {
                showInfoSheet = false
            }
    ...
    private var instructionsCard: some View {
        VStack(spacing: 16) {
            if let uiImage = UIImage(named: "squats") {
            ...
            Text(L10n.Exercise.doSquats)
                .font(.system(size: 28, weight: .bold))
                .foregroundStyle(.white)

            Text(L10n.Exercise.squatInstructions)
                .font(.system(size: 16))
    ...
    private var centerCounter: some View {
        VStack(spacing: 8) {
            ...
            Text(L10n.Exercise.squatsLabel)
                .font(.system(size: 16, weight: .semibold))
    ...
    private var permissionRequiredView: some View {
        VStack(spacing: 24) {
            ...
            Text(L10n.Exercise.cameraTrackingSquats())
                .font(.system(size: 16))
                .foregroundStyle(.white.opacity(0.7))
                .multilineTextAlignment(.center)
    ...
    private var celebrationOverlay: some View {
        ZStack {
            ...
            VStack(spacing: 24) {
                ...
                Text(L10n.Exercise.legDayChampion)
                    .font(.system(size: 32, weight: .bold))
                    .foregroundStyle(.white)

                Text(L10n.Exercise.didSquats(exerciseDetection.currentCount))
                    .font(.system(size: 18))
                    .foregroundStyle(.white.opacity(0.8))
    ...
    private func startExercise() {
        ...
        exerciseDetection.startDetection(type: .squats, target: 999)
    }

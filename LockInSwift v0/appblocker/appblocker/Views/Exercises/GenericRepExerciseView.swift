...
/// Generic exercise view for rep-based exercises (jumping jacks, lunges, crunches, etc.)
struct GenericRepExerciseView: View {
    ...
    private var rewardPerRep: Double {
    ...
    private var buttonText: String {
        if !isStarted {
            ...
            return L10n.Exercise.doSomeExercise(exerciseType.displayName)
        }
    }
    ...
    private var celebrationOverlay: some View {
        ZStack {
            ...
            VStack(spacing: 24) {
                ...
                Text("\(exerciseDetection.currentCount) \(exerciseType.displayName)")
                    .font(.system(size: 18))
                    .foregroundStyle(.white.opacity(0.8))

...
enum L10n {
    ...
    enum Onboarding {
        ...
        // Reviews
        static let review1Text = "onboarding.review1_text".localized
        static let review1Author = "onboarding.review1_author".localized
        static let review2Text = "onboarding.review2_text".localized
        static let review2Author = "onboarding.review2_author".localized
        static let review3Text = "onboarding.review3_text".localized
        static let review3Author = "onboarding.review3_author".localized
        static let review4Text = "onboarding.review4_text".localized
        static let review4Author = "onboarding.review4_author".localized
    }
